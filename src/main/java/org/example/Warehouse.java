...
public class Warehouse {
    ...
    // cascade = CascadeType.ALL sorgt dafür, dass Produkte automatisch
    // mitgespeichert werden, wenn das Warehouse gespeichert wird.
    @OneToMany(mappedBy = "warehouse", cascade = CascadeType.ALL, fetch = FetchType.EAGER)
    private List<Product> productData;

    // Standard-Konstruktor (notwendig für JPA)
    public Warehouse() {}
